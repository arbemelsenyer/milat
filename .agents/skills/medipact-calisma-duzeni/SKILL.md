...
Proje klasörü: `C:\Users\ASUS\Desktop\medipact Codex` (bütün dosyalar burada).
...
dosyadır (ayrıca `COWORK.md` ve `AGENTS.md` içine de tam metin olarak işlendi).

## Token/zaman tasarrufu

Bu skill zaten tasarrufun kendisidir: `COWORK.md`/`AGENTS.md` içine gömülü uzun
