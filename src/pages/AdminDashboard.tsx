...
import { MessageCircle, LogOut, Calendar, User, Clock, Users, Shield, Loader2, ArrowLeft, UserPlus } from 'lucide-react';
      ...
      <div className="container max-w-6xl py-8 px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1">
            {language === 'tr' 
              ? 'Talepleri görüntüleyin ve arabulucu atayın' 
              : 'View requests and assign mediators'}
          </p>
        </div>
