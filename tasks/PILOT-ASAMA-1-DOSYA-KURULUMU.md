...
| 16 | (KURAL, kurucu 11.09) **EKRAN KİLİDİ YOK — bütün adımlar açık.** Bir adım bitmeden öteki kilitlenmez; arabulucu sırayı kendi seçer, atlar, geri döner, bir adımı daha erken yapabilir. Numaralar önerilen sıradır, zorunluluk değil. Sistem yalnız **uyarır** (küçük italik: "Süreç bilgilendirmesi henüz gönderilmedi", "Taraf girilmedi"), düğmeyi kapatmaz. Gerçekten üretecek verisi olmayan bir adım hata vermez; **neyin eksik olduğunu** söyler. Gerekçe (kurucu): "hangi aşamada ne aksak göremiyorum, uydurma veri girmek zorunda kalıyorum." Bu kural Aşama 1'in tamamı ve sonraki bütün aşamalar için geçerlidir |
| 15 | (OLMADI-3, kurucu 11.09 canlı ön izleme) **TEK TABİR + TEK DÜZEN.** 1.10'da bir tarafta "Davet gönder", ötekinde "Davet Linki Oluştur" yazıyordu; taraf satırları da aynı dizilişte değildi. Kural: aynı iş her yerde **aynı kelimeyle** yazılır ("Davet gönder"), her tarafın satırı **birebir aynı dizilişte** durur — ad · sıfat (Başvurucu/Karşı taraf) · tür (Bireysel/Kurumsal) · iletişim · vekil · düğme, hep aynı sırada ve aynı hizada. Taraf sayısı değişince düzen değişmez; eksik bilgi satırı kaydırmaz, yerinde "e-posta yok" / "Vekil girilmedi" diye durur. Bu kural Aşama 1'in TAMAMI için geçerlidir, yalnız 1.10 için değil |
